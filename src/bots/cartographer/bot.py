"""CartographerBot — Tier 4 documentation bot (canary for fleet refactoring)."""
...
class CartographerBot(FleetBot):
    """Tier 4 documentation bot. Canary for the fleet refactoring."""
