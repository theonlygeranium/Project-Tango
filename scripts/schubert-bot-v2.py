#!/usr/bin/env python3
"""
Schubert Bot V2 — Multi-project autonomous agent with MCP, memory, and voice.
...
V1 features preserved:
  - Admiral Schubert Maine Coon cat persona
...
MAX_ITERATIONS = 10
AGENT_TIMEOUT = 300
TOOL_OUTPUT_LIMIT = 4000  # Tool results longer than this are truncated with a warning
SHELL_TIMEOUT = 120
...
MCP_TOOL_CACHE_TTL = 1800  # Refresh MCP tool definitions every 30 minutes
MCP_TOOL_CACHE_REFRESH_ON_ERROR = True  # Refresh cache immediately on tool call errors
...
MAX_MEMORY_INJECTION_TOKENS = 1200  # Limit recalled memories to prevent context bloat
...
async def init_v2():
    ...
    try:
        ...
        memory_store.store(
            "Schubert Bot V2 started. Phase 1 (MCP), Phase 2 (projects/sessions), "
...
async def async_main() -> int:
    log("=" * 60, "INFO")
    log("Schubert Bot V2 — Multi-project agent with MCP, memory, and voice", "INFO")
